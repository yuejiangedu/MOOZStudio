...
const buildAxis = (src: THREE.Vector3, dst: THREE.Vector3, color: string, dashed: boolean) => {
  let geometry = new THREE.Geometry();
  let material: THREE.LineDashedMaterial | THREE.LineBasicMaterial;
...
class CoordinateAxes extends THREE.Group {
