...
export interface ITrackballControls extends THREE.EventDispatcher {
...
class TrackballControls extends THREE.EventDispatcher implements ITrackballControls {
    constructor(object: THREE.PerspectiveCamera | THREE.OrthographicCamera, domElement?: HTMLElement) {
        ...
        this.setMouseButtonState = function (button: number, state: number) {
        ...
        this.getMouseButtonState = function (button: number) {
        ...
        this.handleResize = function () {
            ...
            if (this.domElement === document) {
                ...
                var box = (this.domElement as HTMLElement).getBoundingClientRect();
        ...
        this.zoomIn = function (delta: number) {
            if (!delta) {
                return;
            }
        ...
        this.zoomOut = function (delta: number) {
            if (!delta) {
                return;
            }
