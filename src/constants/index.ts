...
//connect type
export const CONNECT_WIDGET_GORGE = "Serialport";
export const CONNECT_WIDGET_WIFI = "Wifi";

export const SIDERWIDTH = 302;
export const RIGHT_SIDER_WIDTH = 376;
export const LEFT_SIDER_WIDTH = 100;
export const CONTAINER_MARGIN = 10;
export const NAVBAR_HEIGHT = 60;
export const WORKSPACE_HEADERTOOL_HEIGHT = 40;

export const CAMERA_MODE_PAN = "pan";
export const CAMERA_MODE_ROTATE = "rotate";

//text size
export const FONTSIZE = 10; //mm
export const FONTWEIGHT = 2;

export const MM_PER_INCH = 25.4;

export const PRINTING_SPACE: {
